        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="admin-panel-card">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="content" id="content-editor" rows="15" class="form-input">{{ old('content', $post->content) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            <div class="admin-panel-card">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="tags" value="{{ old('tags', $post->tags) }}" class="form-input" placeholder="tips, tutorial, berita">
                </div>

                <div class="mb-4">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_published" value="1" {{ old('is_published', $post->is_published) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 rounded">
                        <span class="text-sm font-medium text-gray-700">Terbitkan</span>
                    </label>
                </div>

                <button type="submit" class="btn-primary w-full">
                    <i class="fas fa-save mr-1"></i> Perbarui Postingan
                </button>
            </div>
        </div>
    </div>
