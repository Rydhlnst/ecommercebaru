    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="admin-panel-card">
                ...
                @endif
                <input type="file" name="images[]" accept="image/*" multiple class="form-input" onchange="previewImages(this)">
                            ...
                            @foreach(old('variation_price', $product->variations) as $i => $v)
                                <div class="variation-row flex gap-3 items-end">
                                    <div class="flex-1">
                                        ...
                                        <input type="number" name="variation_weight[]" step="0.01" value="{{ is_object($v) ? $v->weight : (old('variation_weight')[$i] ?? '') }}" class="form-input">
                                    </div>
                                    <div class="flex-1">
