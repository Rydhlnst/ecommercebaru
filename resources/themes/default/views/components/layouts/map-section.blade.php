...
<section id="lokasi" style="background-color:#2D5A27;">
    <div class="mx-auto max-w-[1600px] px-4 sm:px-6 md:px-10 lg:px-14 py-10 md:py-14">
        <div class="grid gap-8 md:gap-12 lg:grid-cols-2 items-start">
            ...
            {{-- Info kolom --}}
            <div>
                <p class="text-[11px] tracking-[0.14em] uppercase mb-3 text-white/60">{{ $eyebrow }}</p>
                <h2 class="text-3xl sm:text-4xl md:text-5xl text-white" style="font-weight:600; letter-spacing:-0.02em;">
                    {{ $title }}
                </h2>
                <p class="mt-4 text-sm md:text-base text-white/80 leading-relaxed max-w-md">
                    {{ $desc }}
                </p>

                <dl class="mt-8 space-y-5">
                    <div class="flex gap-3">
                        <span class="shrink-0 mt-0.5 text-white/60">
                        ...
                        <div>
                            <dt class="text-xs tracking-[0.14em] uppercase text-white/40 mb-1">Alamat</dt>
                            <dd class="text-sm md:text-base text-white leading-relaxed">
                                {!! nl2br(e($address)) !!}
                            </dd>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            <dt class="text-xs tracking-[0.14em] uppercase text-white/40 mb-1">Jam operasional</dt>
                            <dd class="text-sm md:text-base text-white leading-relaxed">
                                {!! nl2br(e($hours)) !!}
                            </dd>
                        </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            <dt class="text-xs tracking-[0.14em] uppercase text-white/40 mb-1">Kontak</dt>
                            <dd class="text-sm md:text-base text-white leading-relaxed">
                                <a href="tel:{{ preg_replace('/\D/', '', $phone) }}" class="hover:text-white/70 transition-colors">{{ $phone }}</a><br>
                                <a href="mailto:{{ $email }}" class="hover:text-white/70 transition-colors">{{ $email }}</a>
                            </dd>
                        </div>
                    </div>
                </dl>
                ...
                <a
                    ...
                    class="mt-8 inline-flex items-center gap-2 px-6 py-3 text-[13px] tracking-[0.14em] uppercase text-ink bg-white transition-colors hover:bg-white/90"
            ...
            {{-- Map embed --}}
            <div class="relative w-full aspect-video overflow-hidden bg-white/10" style="border-radius:16px;">
                <iframe
