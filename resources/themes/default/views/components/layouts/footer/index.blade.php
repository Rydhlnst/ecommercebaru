                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        @foreach ($col4Links as $link)
                            ...
                            @endphp
                            @if ($icon)
                                <a href="{{ $url }}" target="_blank" rel="noopener" class="text-mist/80 hover:text-cream transition-colors" aria-label="{{ $link['title'] }}">
                                    {!! $icon !!}
                                </a>
                            @else
                                <a href="{{ $url }}" target="_blank" rel="noopener" class="text-sm text-mist/80 hover:text-cream transition-colors">
                                    {{ $link['title'] }}
                                </a>
                            @endif
                        @endforeach
