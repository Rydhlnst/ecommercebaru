...
>
    ...
    <div class="min-h-screen bg-cream flex flex-col items-center justify-center px-6 py-10">
        ...
        <div class="w-full max-w-sm bg-cream border border-mist p-7">
            <h1 class="text-2xl text-ink" style="font-weight: 500; letter-spacing: -0.02em;">Login</h1>
            <p class="mt-1.5 text-sm text-stone">Welcome back — enter your details.</p>
                    ...
                    <x-shop::form.control-group class="!mb-2">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="toggle-password"
                                ...
                                onclick="togglePasswordVisibility()" aria-label="Show password"></button>
                        </div>
