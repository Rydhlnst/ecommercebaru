@push('meta')
    <meta name="description" content="Atur kata sandi baru"/>
...
<x-shop::layouts
    ...
    :has-footer="false"
>
    <x-slot:title>Reset Kata Sandi</x-slot>
    ...
    <div class="min-h-screen bg-cream flex flex-col items-center justify-center px-6 py-10">
        ...
        <div class="w-full max-w-sm bg-cream border border-mist p-7">
            ...
            <h1 class="text-2xl text-ink text-center" style="font-weight: 500; letter-spacing: -0.02em;">Reset kata sandi</h1>
            <p class="mt-1.5 text-sm text-stone text-center">Buat kata sandi baru untuk melanjutkan.</p>
            ...
            <div class="mt-6">
                <x-shop::form :action="route('shop.customers.reset_password.store')">
                    ...
                    <x-shop::form.control-group class="!mb-3">
                        <x-shop::form.control-group.label for="password" class="sr-only">Kata sandi baru</x-shop::form.control-group.label>
                        <div class="relative">
                            ...
                            <x-shop::form.control-group.control
                                ...
                                label="Kata sandi baru" placeholder="Kata sandi baru" ref="password"
                                aria-label="Kata sandi baru" aria-required="true"
                            />
