@push('meta')
    <meta name="description" content="Buat akun Anda"/>
...
>
    ...
    <div class="min-h-screen bg-cream flex flex-col items-center justify-center px-6 py-10">
        ...
        <div class="w-full max-w-sm bg-cream border border-mist p-7">
            <h1 class="text-2xl text-ink" style="font-weight: 500; letter-spacing: -0.02em;">Buat Akun</h1>
            <p class="mt-1.5 text-sm text-stone">Bergabung — kurang dari satu menit.</p>
                ...
                <x-shop::form :action="route('shop.customers.register.store')">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <x-shop::form.control-group class="!mb-3">
                            <x-shop::form.control-group.label for="first_name" class="sr-only">Nama depan</x-shop::form.control-group.label>
                            <div class="relative">
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    label="Nama depan" placeholder="Nama depan" aria-label="Nama depan" aria-required="true"
                                />
                            </div>
                        ...
                        <x-shop::form.control-group class="!mb-3">
                            <x-shop::form.control-group.label for="last_name" class="sr-only">Nama belakang</x-shop::form.control-group.label>
                            <x-shop::form.control-group.control
                                ...
                                label="Nama belakang" placeholder="Nama belakang" aria-label="Nama belakang" aria-required="true"
                            />
                    ...
                    <x-shop::form.control-group class="!mb-3">
                        ...
                        <div class="relative">
                            ...
                            <x-shop::form.control-group.control
                                ...
                                label="Kata Sandi" placeholder="Kata Sandi" ref="password"
                                aria-label="Kata Sandi" aria-required="true"
                            />
                            <button type="button" class="icon-eye absolute right-3 top-1/2 -translate-y-1/2 text-lg text-stone hover:text-ink"
                                onclick="togglePw('password', this)" aria-label="Tampilkan kata sandi"></button>
                        </div>
                        <x-shop::form.control-group.error control-name="password" />
                    </x-shop::form.control-group>

                    <x-shop::form.control-group class="!mb-2">
                        <x-shop::form.control-group.label for="password_confirmation" class="sr-only">Konfirmasi kata sandi</x-shop::form.control-group.label>
                        <div class="relative">
                            <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-stone pointer-events-none" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <x-shop::form.control-group.control
                                ...
                                class="!w-full !pl-10 !pr-10 !py-2.5 !text-sm !border !border-mist !bg-transparent !text-ink placeholder:!text-stone !rounded-none focus:!border-ink focus:!ring-0"
                                label="Konfirmasi kata sandi" placeholder="Konfirmasi kata sandi"
                                aria-label="Konfirmasi kata sandi" aria-required="true"
                            />
                            <button type="button" class="icon-eye absolute right-3 top-1/2 -translate-y-1/2 text-lg text-stone hover:text-ink"
                                onclick="togglePw('password_confirmation', this)" aria-label="Tampilkan kata sandi"></button>
                        </div>
                    ...
                    @if (core()->getConfigData('customer.settings.create_new_account_options.news_letter'))
                        <label class="mt-2 flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-[12px] text-stone">Berlangganan newsletter</span>
                        </label>
                    @endif
