...
return [
    ...
    'modules' => [
         ...
         */
        Beres\Dashboard\Providers\ModuleServiceProvider::class,
        Beres\Product\Providers\ModuleServiceProvider::class,
        Beres\Customer\Providers\ModuleServiceProvider::class,
        Beres\Order\Providers\ModuleServiceProvider::class,
        Beres\Inventory\Providers\ModuleServiceProvider::class,
