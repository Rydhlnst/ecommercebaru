...
>
    ...
    <!-- Page Header -->
    <div class="flex flex-wrap bg-cream">
        <div class="flex w-full justify-between border-b border-mist px-6 md:px-10 lg:px-14 py-5">
    ...
    <div class="flex-auto bg-cream min-h-[70vh]">
        <div class="mx-auto max-w-[1600px] px-6 md:px-10 lg:px-14 pt-10">
            <p class="eyebrow mb-3">Placeholder — Bag</p>
            <h1 class="font-serif text-4xl md:text-5xl text-ink mb-8">Your cart</h1>
