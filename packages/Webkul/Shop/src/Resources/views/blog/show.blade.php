    ...
    <div class="mx-auto max-w-[1600px] px-4 sm:px-6 md:px-10 lg:px-14 py-8 md:py-12">
        ...
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <aside class="w-full lg:w-[360px] lg:shrink-0 space-y-6 lg:sticky lg:top-24">
                {{-- Share Box with crisp inline SVGs --}}
                <div class="p-6 bg-white rounded-2xl border border-[#E8F0E5] shadow-xs">
                    ...
                    <div class="grid grid-cols-2 gap-2.5">
                        {{-- WhatsApp --}}
                        <a href="https://wa.me/?text={{ $shareTitle }}%20{{ urlencode($currentUrl) }}" target="_blank" rel="noopener" class="h-10 px-3 rounded-xl bg-[#25D366] hover:bg-[#1EBE5D] text-white flex items-center justify-center gap-2 text-xs font-semibold transition-all shadow-xs" title="Share ke WhatsApp">
                        ...
                        {{-- Facebook --}}
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($currentUrl) }}" target="_blank" rel="noopener" class="h-10 px-3 rounded-xl bg-[#1877F2] hover:bg-[#0D65D9] text-white flex items-center justify-center gap-2 text-xs font-semibold transition-all shadow-xs" title="Share ke Facebook">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            <span>Facebook</span>
                        </a>
                        {{-- Twitter/X --}}
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode($currentUrl) }}&text={{ $shareTitle }}" target="_blank" rel="noopener" class="h-10 px-3 rounded-xl bg-[#171717] hover:bg-black text-white flex items-center justify-center gap-2 text-xs font-semibold transition-all shadow-xs" title="Share ke X">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                            <span>X / Twitter</span>
                        </a>
                        {{-- Copy Link --}}
                        <button type="button" onclick="navigator.clipboard.writeText('{{ $currentUrl }}'); alert('Link artikel berhasil disalin!');" class="h-10 px-3 rounded-xl bg-zinc-100 hover:bg-zinc-200 text-zinc-700 flex items-center justify-center gap-2 text-xs font-semibold transition-all shadow-xs" title="Salin Tautan">
