            ...
            <div class="relative overflow-hidden bg-canvas aspect-[4/5]">
                ...
                >
                    <x-shop::media.images.lazy
                        class="absolute inset-0 w-full h-full object-contain p-0 transition-opacity duration-500 group-hover:opacity-0"
                    ...
                    <img
                        class="absolute inset-0 w-full h-full object-contain p-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100 scale-[1.02]"
                ...
                <div class="absolute top-3 right-3 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 max-lg:opacity-100">
                    ...
                    @if (core()->getConfigData('catalog.products.settings.compare_option'))
                        <button
                            class="icon-compare w-9 h-9 rounded-full bg-cream/95 flex items-center justify-center text-lg text-ink hover:bg-cream transition-colors"
        ...
        >
            <div class="group relative w-[220px] h-[275px] flex-shrink-0 overflow-hidden bg-canvas">
                ...
                <a :href="'{{ route('shop.product_or_category.index', ':slug') }}'.replace(':slug', product.url_key)">
                    <x-shop::media.images.lazy
                        class="absolute inset-0 w-full h-full object-contain p-0 transition-transform duration-500 group-hover:scale-[1.03]"
                        ::src="product.base_image.medium_image_url"
                        ::key="product.id"
                        ::index="product.id"
                        width="291"
