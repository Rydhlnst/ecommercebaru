        ...
        <div>
            ...
            <div class="flex justify-between max-md:hidden">
                ...
                >
                    <x-slot:toggle>
                        <!-- Dropdown Toggler -->
                        <button class="flex w-full max-w-[200px] cursor-pointer items-center justify-between gap-4 rounded-sm border border-mist bg-transparent px-4 py-3 text-[13px] tracking-widelg uppercase text-ink transition-all hover:border-ink focus:border-ink max-md:w-[110px] max-md:border-0 max-md:pl-2.5 max-md:pr-2.5">
