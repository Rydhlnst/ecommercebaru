    ...
    @pushOnce('scripts')
        ...
        >
            <div class="mx-auto max-w-[1600px] px-6 md:px-10 lg:px-14">
                <div class="mt-6 mb-8 md:mt-12 md:mb-10">
                    <p class="eyebrow mb-3">Placeholder — Category</p>
                    <h1 class="font-serif text-4xl md:text-5xl text-ink">{{ $category->name ?? 'Collection' }}</h1>
                </div>
                <div class="flex items-start gap-10 max-lg:gap-5">
                    ...
                    <div class="flex-1">
                        ...
                        <!-- Load More Button -->
                        <button
                            class="secondary-button mx-auto mt-16 block"
