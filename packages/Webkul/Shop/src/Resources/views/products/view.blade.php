...
<x-shop::layouts>
    ...
    <!-- Information Section -->
    <div class="mx-auto max-w-[1600px] px-6 md:px-10 lg:px-14 mt-20 md:mt-28">
            ...
            >
                ...
                >
                    ...
                    <div class="mx-auto max-w-[1600px] px-6 md:px-10 lg:px-14">
                        <div class="mt-10 grid gap-12 lg:grid-cols-[1.4fr_1fr] max-lg:mt-4">
                                    ...
                                    <div class="flex gap-3 items-stretch">
                                        ...
                                        @if ($product->getTypeInstance()->showQuantityBox())
                                            <x-shop::quantity-changer
                                                name="quantity"
                                                value="1"
                                                class="gap-x-4 rounded-pill border border-ink px-5 py-3 bg-transparent"
                                            />
                                        @endif
                                        ...
                                        @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                                            ...
                                            <x-shop::button
                                                type="submit"
                                                class="primary-button flex-1 !max-w-full"
