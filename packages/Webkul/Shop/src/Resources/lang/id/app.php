...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'nav-fruits-vegetables' => 'Buah & Sayur',
                        'nav-meat-seafood' => 'Daging & Seafood',
                        'nav-bread-bakery' => 'Roti & Bakery',
                        'nav-beverages' => 'Minuman',
                        'nav-spices-herbs' => 'Bumbu & Rempah',
                        'nav-healthy-snacks' => 'Snack Sehat',
                    ],
                ],
            ...
            'footer' => [
                ...
                'newsletter-desc' => 'Jadilah yang pertama mendengar tentang produk baru, acara eksklusif, dan penawaran online.',
                'join-us' => 'Gabung',
                'shop-title' => 'BELANJA',
                'useful-links' => 'TAUTAN BERGUNA',
                'privacy-policy' => 'Kebijakan Privasi',
                'refund-policy' => 'Kebijakan Pengembalian',
                'shipping-policy-title' => 'Kebijakan Pengiriman',
        ...
        'products' => [
            'card' => [
                ...
                'sold-out' => 'Habis',
                'size' => 'Ukuran',
                'see-product' => 'Lihat produk',
                'add-to-wishlist-aria' => 'Tambah ke wishlist',
                'decrease-qty' => 'Kurangi',
                'increase-qty' => 'Tambah',
                'quantity' => 'Jumlah',
            ],
    ...
    'home' => [
        ...
        'custom' => [
            'hero-aria'        => 'Carousel hero',
            'slide-alt'        => 'Slide :number',
            'prev-slide'       => 'Slide sebelumnya',
            'next-slide'       => 'Slide berikutnya',
            'add-to-cart'      => 'Tambah ke Keranjang',
            'buy-it-now'       => 'Beli Sekarang',
            'view-full-details'=> 'Lihat detail lengkap',
            'new-arrivals'     => 'Produk Terbaru',
            'kits-bundles'     => 'Paket & Bundel',
            'natural-text1'    => '100% ALAMI',
            'natural-text2'    => 'BERSERTIFIKAT LAB',
            'shop-by-category' => 'Belanja per Kategori',
            'see-all-categories' => 'Lihat Semua Kategori',
            'best-seller'      => 'Produk Terlaris Sepanjang Masa',
            'seeds-superfoods' => 'Biji & Superfood Kami',
            'see-all'          => 'Lihat Semua',
            'customer-reviews' => 'Ulasan Pelanggan',
            'reviews-eyebrow'  => '4,8 dari 2.400+ ulasan',
            'write-review'     => 'Tulis ulasan',
            'see-all-reviews'  => 'Lihat semua ulasan',
            'faq'              => 'FAQ',
            'blog-cta-title'   => 'Baca tips produk favorit untuk gaya hidup lebih sehat.',
            'blog-cta-button'  => 'Lihat semua blog',
            'latest-blogs'     => 'Blog Terbaru',
            'browse-blogs'     => 'Jelajahi Blog Kesehatan',
            'read-article'     => 'Baca artikel',
            'anonymous'        => 'Anonim',
            'adding'           => 'Menambahkan…',
            'added'            => '✓ Ditambahkan',
            'cart-error'       => 'Gagal menambahkan ke keranjang. Coba lagi.',
            'server-error'     => 'Gagal terhubung ke server.',

            'trust' => [
                'pick-up'           => 'Ambil di Toko',
                'pick-up-desc'      => 'Ambil di gerai fisik kami',
                'fastest-delivery'  => 'Pengiriman Tercepat',
                'fastest-desc'      => 'Sameday area Jakarta',
                'best-offer'        => 'Zona Penawaran Terbaik',
                'best-offer-desc'   => 'Promo harian & bundle hemat',
                'best-quality'      => 'Kualitas Terbaik',
                'best-quality-desc' => '100% alami & bersertifikat lab',
            ],

            'map' => [
                'eyebrow'     => 'Kunjungi kami',
                'title'       => 'Lokasi & kontak',
                'description' => 'Mampir ke gerai fisik kami untuk pengalaman belanja langsung, atau hubungi tim kami untuk pertanyaan seputar produk & pengiriman.',
                'address'     => 'Alamat',
                'hours'       => 'Jam operasional',
                'contact'     => 'Kontak',
                'open-maps'   => 'Buka di Google Maps',
            ],
        ],
    ],
