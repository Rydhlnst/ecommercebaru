    ...
    public function run($parameters = [])
    {
        ...
        DB::table('attributes')->insert([
            [
                ...
                'id' => 29,
                'code' => 'allow_rma',
                'admin_name' => trans('installer::app.seeders.attribute.attributes.allow-rma', [], $defaultLocale),
                'type' => 'boolean',
                'validation' => null,
                'position' => 1,
                'is_required' => 0,
                ...
                'id' => 30,
                'code' => 'rma_rule_id',
                'admin_name' => trans('installer::app.seeders.attribute.attributes.rma-rules', [], $defaultLocale),
                'type' => 'select',
                'validation' => null,
                'position' => 5,
                'is_required' => 0,
            ...
            [
                'id' => 36,
                'code' => 'dietary_info',
                'admin_name' => 'Dietary Information',
                'type' => 'multiselect',
                'validation' => null,
                'position' => 35,
                'is_required' => 0,
            ...
            [
                'id' => 39,
                'code' => 'allergen_info',
                'admin_name' => 'Allergen Information',
                'type' => 'textarea',
                'validation' => null,
                'position' => 38,
                'is_required' => 0,
        ...
        foreach ($locales as $locale) {
            DB::table('attribute_translations')->insert([
                [
                    ...
                    'locale' => $locale,
                    'name' => trans('installer::app.seeders.attribute.attributes.allow-rma', [], $locale),
                    'attribute_id' => 29,
                ], [
                    'locale' => $locale,
