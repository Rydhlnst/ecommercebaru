...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Halo {{ $order->customer->first_name ?? 'Pelanggan' }},</h2>
            
            <p>Terima kasih telah berbelanja di {{ config('app.name') }}!</p>
            
            <p>Pesanan Anda telah berhasil diterima dan sedang kami proses.</p>
            ...
            <p style="text-align: center; margin-top: 30px;">
                <a href="{{ url('/account/orders/' . $order->id) }}" class="btn">Lihat Pesanan</a>
            </p>
        </div>
