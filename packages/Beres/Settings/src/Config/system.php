...
return [
    ...
    [
        ...
        'sort' => 2,
        'fields' => [
            ['name' => 'badge1_title', 'title' => 'Badge 1 — Judul', 'type' => 'text',     'default' => 'Pick Up'],
            ['name' => 'badge1_desc',  'title' => 'Badge 1 — Desc',  'type' => 'text',     'default' => 'Ambil langsung di toko'],
            ['name' => 'badge2_title', 'title' => 'Badge 2 — Judul', 'type' => 'text',     'default' => 'Fastest Delivery'],
            ['name' => 'badge2_desc',  'title' => 'Badge 2 — Desc',  'type' => 'text',     'default' => 'Kirim kilat Jakarta same-day'],
            ['name' => 'badge3_title', 'title' => 'Badge 3 — Judul', 'type' => 'text',     'default' => 'Best Offer Zone'],
            ['name' => 'badge3_desc',  'title' => 'Badge 3 — Desc',  'type' => 'text',     'default' => 'Harga terbaik, diskon setiap hari'],
            ['name' => 'badge4_title', 'title' => 'Badge 4 — Judul', 'type' => 'text',     'default' => 'Best Quality'],
            ['name' => 'badge4_desc',  'title' => 'Badge 4 — Desc',  'type' => 'text',     'default' => '100% alami, tanpa pengawet'],
        ],
    ],
    ...
    [
        ...
        'name' => 'Banner Natural',
        'info' => 'Banner hijau "100% NATURAL · LAB CERTIFIED". Kosongkan link jika tidak ingin di-link.',
        'sort' => 7,
        'fields' => [
            ['name' => 'text1', 'title' => 'Text kiri',  'type' => 'text', 'default' => '100% NATURAL'],
            ['name' => 'text2', 'title' => 'Text kanan', 'type' => 'text', 'default' => 'LAB CERTIFIED'],
            ['name' => 'link',  'title' => 'Link (opsional)', 'type' => 'text', 'default' => '', 'info' => 'URL tujuan saat banner diklik. Contoh: /page/awards'],
        ],
    ],
